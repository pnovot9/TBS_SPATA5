...
Přehled všech štítků `⚠ OVĚŘIT` ve vaultu na jednom místě. Slouží k rychlému projití otevřených otázek. Jakmile je otázka zodpovězena, opravte text ve zdrojovém článku, odstraňte tam štítek a smažte odpovídající řádek zde. Stav k 27. 8. 2026: 18 štítků ve 13 článcích.
...
- **RD-Factory: počet nominací v 1. kole.** Primární zprávy (avcr.cz a img.cas.cz, obě 28. 2. 2025) uvádějí 45 nominací, vzacni.cz 44 návrhů. Rozdíl se z veřejných zdrojů vysvětlit nepodařilo. Ověřit přímo u CCP. Rozpor v počtu vybraných nemocí (11 vs. 12) je vyřešen: přehled CCP z 31. 3. 2026 ukazuje, že se sestava 1. kola po únoru 2025 změnila. Článek: [[rd-factory]].
